...
<form id="Form1" action="update.php" method="post">
   <input type="hidden" name="moving" value=<script>document.getElementById("fixed").value></script>>
...
<button type="submit" name="Submit"><img src="assets/img/up.png" style="width:64px; padding-right:15px; "></button>
            ...
            <p><center> <input type="image" src="assets/img/down.png" style=" width:64px"><br /><h3>Do you like this graph?</h3></p></div>
<div class="well sidebar-nav" id="sidebar" >
